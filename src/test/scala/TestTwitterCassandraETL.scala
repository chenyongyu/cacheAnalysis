...
import sparkapps.dataProcessing.{AllDrugsTwitterAppImplementation, MockInputDStream}
  ...
  def testCassandraETL(){
    ...
    def startCassandraStream() = {
      ...
      AllDrugsTwitterAppImplementation.startStream(1,
        conf,
        sparkapps.dataProcessing.MockInputDStream(1)_, // <-- how to make this curried?
        {
